...
public class Weld1262Test {
	...
	public static WebArchive createDeployment() {
		...
		return ShrinkWrap
				...
				.addAsWebInfResource(Weld1262Test.class.getPackage(), "jboss-web.xml", "jboss-web.xml")
...
//		 assertTrue(Integer.valueOf(cid) > 0);
//		 
//		 HtmlPage road = getFirstMatchingElement(main, HtmlSubmitInput.class, "noguide").click();
//		 
